  ...
  <div className="flex max-w-4xl w-full mx-auto items-center">
    <div className="w-1/2 p-4">
      ...
      <p className="text-gray-700 leading-relaxed">
        Our mission is to make nomad travel easy and safe for everyone.</p>
        <ul>
          <li>Are you introverted and like to discover the world at your own pace? </li>
          <li>Do you want to be able to travel at night without worrying that you will be robbed or assaulted? We have only the safests countries!</li>
